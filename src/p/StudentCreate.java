...
public class StudentCreate { 
	...
	public  void StudentInfo() //static
	{ 
		...
		b1.addActionListener(new ActionListener() { 
			...
			{ 
				...
				StudentDAO obj=new StudentImpDAO();
			//	obj.insertEmp(new Employee("name","s","d","d","g"));
				//obj.insertEmp(new Employee("na","s","d","d","g"));
				obj.insertEmp(new Student(s1,s2,s3,s4,s5));
				//creating new Student object
				for (Object ob : obj.getAllEmp()) {
		            System.out.println("STUDENT: " + ob.toString());
			
		        }
			
				//Student.txt file for having all student details captured in a file
				/*
				if (e.getSource() == b1) { 
					try { 
	...
	{ 
		StudentCreate g=new StudentCreate();//student form
 		g.StudentInfo();
